...
module.exports = {
  ...
  handleErrorResponse: (errorObj, res) => {
    ...
    return res
      ...
      .json(module.exports.errorWith(httpStatusCode, errorObj.message, errorObj.displayMessage, errorObj.customStatusCode));
  },
  handleSuccessResponse: (data, res, message = null, displayMessage = constants.successMessage) => {
